<template>
    <div class="container" :class="{'light-background':!isDarkMode,'dark-background':isDarkMode}">
        <div class="request"
             :class="{'light-request':isDarkMode,
        ...
        <div class="login">
            ...
            <h4 :class="{'light-text':isDarkMode,'dark-text':!isDarkMode}">Sign in Design+Code HQ</h4>
            <input type="email" placeholder="Email"
                   :class="{'light-field':isDarkMode,

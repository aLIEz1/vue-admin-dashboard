<template>
    <div class="home">
        ...
        <div class="container">
            ...
            <apexcharts width="100%" type="area" :options="chartOptions" :series="series"></apexcharts>
        ...
        data() {
            return {
                ...
                series: [
                    {
                        name: 'active users',
                        data: [[new Date("January 1, 2020"), 30], [new Date("January 5, 2020"), 40]]
                    },
                    {
                        name: 'new users',
                        data: [[new Date("January 1, 2020"), 80], [new Date("January 5, 2020"), 20]]
                    }
                ]
            }
        },
